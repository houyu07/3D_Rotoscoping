...
from util import create_gif_from_pngs
...
def main():
    ...
    # clear test_results folder
    test_results_dir = "data/test_results"
    print(f"Clearing directory: {test_results_dir}")
    ...
    # generate GIF
    print("Creating GIF from predicted results...")
    input_dir = './data/test_results'  #  PNG 
    output_path = './output_result.gif'  #  GIF 
    create_gif_from_pngs(input_dir, output_path, fps=30)
